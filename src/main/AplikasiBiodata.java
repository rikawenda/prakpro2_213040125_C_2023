...
public class AplikasiBiodata extends JFrame {
    ...
    public AplikasiBiodata() {
        ...
        buttonHapus.setBackground(new Color(219, 213, 185));
        ...
        buttonSimpan.setBackground(new Color(219, 213, 185));
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nama.isEmpty() || nomorHP.isEmpty() || alamat.isEmpty() || jenisKelamin.isEmpty()) {
                    ...
                    int dialogResult = JOptionPane.showConfirmDialog(AplikasiBiodata.this, "Apakah anda yakin ingin menyimpan data?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
                    if (dialogResult == JOptionPane.YES_OPTION) {
        ...
        buttonHapus.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int selectedRow = table.getSelectedRow();
                if (selectedRow >= 0) {
                    int dialogResult = JOptionPane.showConfirmDialog(AplikasiBiodata.this, "Apakah anda yakin ingin menghapus data ini?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
                    if (dialogResult == JOptionPane.YES_OPTION) {
